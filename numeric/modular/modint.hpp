...
struct modint {
  ...
  public:
    ...
    static constexpr mint zero() noexcept(NO_EXCEPT) { return mint::_raw(mint::context::get().zero()); };
    static constexpr mint one() noexcept(NO_EXCEPT) { return mint::_raw(mint::context::get().one()); };
