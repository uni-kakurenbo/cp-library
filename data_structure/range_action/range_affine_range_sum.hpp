...
template<class T> struct implicit_treap<actions::range_affine_range_sum<T>> : internal::implicit_treap_lib::core<actions::range_affine_range_sum<T>> {
    using internal::implicit_treap_lib::core<actions::range_affine_range_sum<T>>::core;
