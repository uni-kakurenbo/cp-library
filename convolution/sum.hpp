...
auto convolution(const I1 a_frist, const I1 a_last, const I2 b_frist, const I2 b_last) {
...
template<class I1, class I2>
auto convolution_ll(const I1 a_frist, const I1 a_last, const I2 b_frist, const I2 b_last) {
    std::vector<typename std::iterator_traits<I1>::value_type> a(a_first, a_last);
    std::vector<typename std::iterator_traits<I2>::value_type> b(b_first, b_last);
