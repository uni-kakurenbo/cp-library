...
void lib::internal::graph_impl::mixin<Graph>::shortest_path_with_01cost(
...
template<class Graph>
auto lib::internal::graph_impl::mixin<Graph>::shortest_path_with_01cost(const node_type& s) const noexcept(NO_EXCEPT) {
    lib::auto_holder<typename lib::internal::graph_impl::mixin<Graph>::node_type, cost_type> dist;
