...
void lib::graph<edge_cost>::distances(const size_type s, std::vector<cost_t> *const dists) const {
...
template<class edge_cost>
template<class cost_t>
std::vector<cost_t> lib::graph<edge_cost>::distances(const size_type s) const {
