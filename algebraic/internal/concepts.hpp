...
template<class T>
concept associative = magma<T> && std::is_base_of_v<algebraic::associative, T>;

template<class T>
concept commutative = magma<T> && std::is_base_of_v<algebraic::commutative, T>;

template<class T>
concept invertible = magma<T> && lib::internal::unary_subtractable<T>;
